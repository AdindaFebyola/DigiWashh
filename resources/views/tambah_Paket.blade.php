...
<body class="bg-[#F3F8FF]">
    ...
    <div class="flex pt-20 h-screen">
        ...
        <main class="flex-1 p-10">
            <h1 class="text-4xl font-bold text-gray-800 mb-6 text-center" style="font-family: 'Poppins', sans-serif;">Tambah Paket Laundry</h1>
    ...
    <div class="mb-4"> <!-- Margin bawah -->
        ...
        <input type="text" id="harga" name="harga" class="w-full border border-gray-300 px-4 py-2 rounded-md focus:ring-2 focus:ring-blue-500 outline-none" placeholder="Masukkan harga">
    </div>
    ...
    <div class="flex justify-center">
        <button type="submit" class="w-full bg-blue-900 text-white py-2 rounded-md hover:bg-blue-700 transition">Tambah Paket</button>
    </div>
</div>
